...
admin.site.register(TblFixedOutputParameter)
admin.site.register(TblMultiplePracticalImages)
admin.site.register(TblMultipleAppartus)
admin.site.register(TblMultipleYoutubeLinks)
admin.site.register(TblMultipleMaterials)
admin.site.register(TblMultipleInputParameter)
admin.site.register(TblMultipleOutputParameter)
admin.site.register(TblMultipleFixedInputParameter)
admin.site.register(TblMultipleFixedOutputParameter)
